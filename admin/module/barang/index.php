          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
						...
						<?php 
							$sql=" select * from barang where stok <= 20";
						...
						<?php
								...
								<div class='alert alert-warning'>
									<span class='glyphicon glyphicon-info-sign'></span> Ada <span style='color:red'>$r</span> barang yang Stok tersisa sudah kurang dari 20 items. silahkan pesan lagi !!
